...
the implementation of a reinforcement learning algorithm for controlling an ant in the x direction using Recurrent Neural Networks (RNN) [4].
...
[4] Medsker, L.R. and Jain, L.C., 2001. Recurrent neural networks. Design and Applications, 5(64-67), p.2.


---------------------------------
@author: Savan Agrawal
@file: ant_x_direction_rnn_task.py
@version: 0.1
---------------------------------
'''
...
def main():
    ...
    # Define the command line arguments with RNN true
    argv=["--env=Ant-v4", "--device=cpu", "--experiment=ant_x_direction_rnn_task", "--train_dir=./src/rl-training/train_dir", "--use_rnn=True"]
