...
the implementation of a reinforcement learning algorithm for controlling an ant in the x direction using Population Based Training (PBT) [4].
...
[4] Jaderberg, M., Dalibard, V., Osindero, S., Czarnecki, W.M., Donahue, J., Razavi, A., Vinyals, O., Green, T., Dunning, I., Simonyan, 
K. and Fernando, C., 2017. Population based training of neural networks. arXiv preprint arXiv:1711.09846.


---------------------------------
@author: Savan Agrawal
@file: ant_x_direction_pbt_task.py
@version: 0.1
---------------------------------
'''
...
def main():
    ...
    # Define the command line arguments where PBT is true
    argv=["--env=Ant-v4", "--device=cpu", "--experiment=ant_x_direction_pbt_task", "--train_dir=./src/rl-training/train_dir", "--with_pbt=True"]
