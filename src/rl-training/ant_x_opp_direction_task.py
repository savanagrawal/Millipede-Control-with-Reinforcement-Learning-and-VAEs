...
the implementation of a reinforcement learning algorithm for controlling an ant in the opposite x direction. It utlises the Gymnasium [1]
Mujoco Ant-v4 environment [2] and Sample Factory library [3]. With the help of wrapper class, the script rewards the agent for moving in 
...
@file: ant_x_opp_direction_task.py
@version: 0.1
---------------------------------
'''
...
def main():
    ...
    argv=["--env=Ant-v4", "--device=cpu", "--experiment=ant_x_opp_direction_task", "--train_dir=./sample-factory/code/train_dir"]
