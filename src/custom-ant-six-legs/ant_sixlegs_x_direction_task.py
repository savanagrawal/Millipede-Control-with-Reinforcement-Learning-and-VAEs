...
package created [4]. It utlises the Gymnasium [1] Mujoco Ant-v4 environment [2] and Sample Factory library [3]. With the help of 
wrapper class, the script rewards the agent for moving in the x direction. The step function provided by gym is designed to move 
the ant forward, i.e., in x direction. This is why the code is taking each step action and returning the same action for simplicity.
