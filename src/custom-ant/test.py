...
# class AntEnv(MujocoEnv, utils.EzPickle):
    ...
    def __init__(
        ...
        full_env_name, 
        cfg,
        xml_file="/Users/savan/Documents/UofG/MSc Project/Code/custom-ant/ant.xml",
...
def make_gym_env_func(full_env_name, cfg=None, env_config=None, render_mode: Optional[str] = None):
    # base_env = gym.make(xml='ant.xml', render_mode=render_mode)
    # return CustomAntEnv(base_env)
    # return AntEnv(xml_file='./ant.xml', render_mode=render_mode)
    return CustomEnv(full_env_name, cfg, render_mode=render_mode)


def register_custom_components():
    register_env("ant-six-legs", make_gym_env_func)
...
def main():
    ...
    argv=["--env=ant-six-legs", "--device=cpu", "--experiment=test"]
